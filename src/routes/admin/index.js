...
const deepseekAccountsRoutes = require('./deepseekAccounts')
const minimaxAccountsRoutes = require('./minimaxAccounts')
const glmAccountsRoutes = require('./glmAccounts')
const kimiAccountsRoutes = require('./kimiAccounts')
...
router.use('/', deepseekAccountsRoutes)
router.use('/', minimaxAccountsRoutes)
router.use('/', glmAccountsRoutes)
router.use('/', kimiAccountsRoutes)
